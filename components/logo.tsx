...
export function Logo({ light = false, className }: { light?: boolean; className?: string }) {
  return (
    <a href="#home" className={cn("flex items-center gap-2", className)} aria-label="Annabata Procure-Connect home">
      ...
      <span className={cn("leading-none", light ? "text-white" : "text-forest")}>
        <span className="block text-[10px] font-bold tracking-tight">Annabata</span>
